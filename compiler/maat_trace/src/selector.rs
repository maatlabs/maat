...
//! The 16 selector classes partition all opcodes into groups that share
//! algebraic constraint structure in the AIR.

use maat_bytecode::Opcode;

/// Number of selector columns in the trace.
pub const NUM_SELECTORS: usize = 16;
...
/// Returns the selector class index (0..15) for the given opcode.
///
...
pub const fn class_index(op: Opcode) -> u8 {
    match op {
        ...
        Opcode::Add | Opcode::Sub | Opcode::Mul | Opcode::Div | Opcode::Mod => SEL_ARITH,
