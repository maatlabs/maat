...
pub use builtin::{
    ...
    LogUpBuiltin, LogUpColumns, LookupTable, NATIVE_BITS, POOL_SIZE, POOL_TABLE_ID,
    RangeCheckBuiltin, RescueHashBuiltin, SPREAD_MASK, STRIDE, TableId, bitwise_identity_residuals,
